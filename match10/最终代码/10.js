...
function _yrxa$o(_yrxtJ1) {
    // value2 start
    // var _yrxmbl = 25 + _yrxCxm['cCBa'];
    var _yrxmbl = window['value2'] + window['offset'];
    // value2 end
...
function _yrxVhD(_yrxtJ1) {
    // return 1629248846 + _yrxCxm['cCBa'];
    return window['value3'] +window['offset'];
}
...
function _yrxM3E(_yrxvAM) {
    // value1 start
    // var _yrxC2_ = 476 + _yrxCxm['cCBa'];
    var _yrxC2_ = window['value1'] + window['offset'];
    // value1 end
    function _yrxHnj() {
        _yrxdtn = Date;
        // 固定时间戳 1629276848.933
...
function _yrxu8d(_yrx7jl) {
    ...
    var _yrxrqQ = _yrx2tg[_yrxQ9C[0]]("HM4hUBT0dDOnenable=true; m=155", "; ");
...
function get_m(uri,v1,v2,v3,offset){
    window['value1'] = v1
    window['value2'] = v2
    window['value3'] = v3
    window['offset'] = offset
    // console.log(key)
    // var key = '/api/match/10'
    var key = uri
    console.log('key',key)
    var _yrxmEu = _yrxWKg(_yrxyHJ(_yrx5XG(key)));
    var v = _yrxBXT(779, key, _yrxmEu, undefined).replace('m=','')
    return v
} 
